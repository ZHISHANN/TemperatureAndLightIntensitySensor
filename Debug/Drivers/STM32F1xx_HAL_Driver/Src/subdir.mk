...
Drivers/STM32F1xx_HAL_Driver/Src/%.o: ../Drivers/STM32F1xx_HAL_Driver/Src/%.c
	...
	@echo $(PWD)
	arm-none-eabi-gcc -mcpu=cortex-m3 -mthumb -mfloat-abi=soft '-D__weak=__attribute__((weak))' '-D__packed=__attribute__((__packed__))' -DUSE_HAL_DRIVER -DSTM32F103xB -I"E:/AGILE SOFTWARE DEVELOPMENT/Sensor/Temperature_LightIntensity/Inc" -I"E:/AGILE SOFTWARE DEVELOPMENT/Sensor/Temperature_LightIntensity/Drivers/STM32F1xx_HAL_Driver/Inc" -I"E:/AGILE SOFTWARE DEVELOPMENT/Sensor/Temperature_LightIntensity/Drivers/STM32F1xx_HAL_Driver/Inc/Legacy" -I"E:/AGILE SOFTWARE DEVELOPMENT/Sensor/Temperature_LightIntensity/Drivers/CMSIS/Device/ST/STM32F1xx/Include" -I"E:/AGILE SOFTWARE DEVELOPMENT/Sensor/Temperature_LightIntensity/Drivers/CMSIS/Include"  -Og -g3 -Wall -fmessage-length=0 -ffunction-sections -c -fmessage-length=0 -MMD -MP -MF"$(@:%.o=%.d)" -MT"$@" -o "$@" "$<"
